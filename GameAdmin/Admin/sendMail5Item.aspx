            ...
            <table style="width: 100%;">
                <tr>
                    <td class="style1485"
                        ...
                        onmouseover="$(this).css({ background: '#2C2c2B', color: '#FFFFFF'});">Gửi Items
                    </td>
                    <td class="style1451"
                        onclick="show_SendMoney();"
                        onmouseout="$(this).css({ background: '#15222E', color: '#B0D551'});"
                        onmouseover="$(this).css({ background: '#2C2c2B', color: '#FFFFFF'});">Gửi Xu
                    </td>
                    <td class="style1451"
                        onclick="show_SendCoin();"
                        onmouseout="$(this).css({ background: '#15222E', color: '#B0D551'});"
                        onmouseover="$(this).css({ background: '#2C2c2B', color: '#FFFFFF'});">Gửi Coin
                    </td>
                    <td class="style1448">&nbsp;&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="4">
                        <div id="divSendMail" class="style1476">
                            <table style="border: medium #000080 solid; width: 100%;">
                                ...
                                <tr>
                                    <td class="style1455">Item đính kèm:<strong> </strong>
                                ...
                                </span><span class="auto-style1">Cảnh báo tất cả các vật phẩm&nbsp; mặc định là <strong>vĩnh cửu</strong>.</span></td>
                                </tr>
                                <tr>
                                    <td class="style1454">
                                        <table cellpadding="0" cellspacing="0" class="style1462">
                                            <tr>
                                                <td class="style1463">
                                                    <table class="style1466">
                                                        <tr>
                                                            <td id="td_item1" class="style1484" rowspan="2">Item 1</td>
                                                            <td class="style1468"
                                                                onclick="del_ItemsAtt(1);"
                                                                onmouseout="$(this).css({ background: '#15222E', color: '#B0D551'});"
                                                                onmouseover="$(this).css({ background: '#2C2c2B', color: '#FFFFFF'});">Xóa</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="style1468"
                                                                onclick="custom_Items(1, 'customItems');"
                                                                onmouseout="$(this).css({ background: '#15222E', color: '#B0D551'});"
                                                                onmouseover="$(this).css({ background: '#2C2c2B', color: '#FFFFFF'});">Tùy chọn</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="style1463">
                                                    <table class="style1466">
                                                        <tr>
                                                            <td id="td_item2" class="style1484" rowspan="2">Item 2</td>
                                                            <td class="style1468"
                                                ...
                                                <td class="style1464">
                                                    <table class="style1466">
                                                        <tr>
                                                            <td id="td_item3" class="style1484" rowspan="2">Item 3</td>
                                                            <td class="style1468"
                                            ...
                                            <tr>
                                                <td class="style1463">
                                                    <table class="style1466">
                                                        <tr>
                                                            <td id="td_item4" class="style1484" rowspan="2">Item 4</td>
                                                            <td class="style1468"
                                                ...
                                                <td class="style1463">
                                                    <table class="style1466">
                                                        <tr>
                                                            <td id="td_item5" class="style1484" rowspan="2">Item 5</td>
                                                            <td class="style1468"
