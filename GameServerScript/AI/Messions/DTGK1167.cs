...
namespace GameServerScript.AI.Messions
{
    public class DTGK1167 : AMissionControl
    {
        ...
        private int m_oaituID = 6231;//oai tu

        private int m_trongtaiID = 6232;//trong tai coi den

        private int m_fanID = 6234;//Fan

        private int m_decuatrongtaiID = 6235;//De cua trong tai
