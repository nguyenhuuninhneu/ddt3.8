...
namespace GameServerScript.AI.Messions
{
    public class WAT13304 : AMissionControl
    {
        ...
        private int[] m_locationX = new int[] { 83, 90, 100, 110, 125, 135, 145, 265, 600, 650, 700, 750, 800, 850, 990, 1400, 1550, 1620, 1760, 1800, 1910 };

        private int m_turnMax = 3;
