...
namespace GameServerScript.AI.NPC
{
	...
	public class TwelveSimpleFlyThirdBoss : ABrain
	{
		...
		private void ReadyElectricAttack()
		{
			...
			int index = base.Game.Random.Next(0, TwelveSimpleFlyThirdBoss.ElectricChat.Length);
			base.Body.Say(TwelveSimpleFlyThirdBoss.ElectricChat[index], 1, 0);
		...
		private void HoleAttack()
		{
			...
			int index = base.Game.Random.Next(0, TwelveSimpleFlyThirdBoss.HoleChat.Length);
			base.Body.Say(TwelveSimpleFlyThirdBoss.HoleChat[index], 1, 0);
			foreach (Player allFightPlayer in base.Game.GetAllFightPlayers())
			{
