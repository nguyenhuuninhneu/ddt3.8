        ...
        public void GameOver()
        {
            ...
            foreach (Player p in players)
            {
                ...
                if (base.RoomType == eRoomType.Match)
                {
                    ...
                    //foreach (var item in GameProperties.GoldTimeStart.Split('|'))
                    //{
                    //    GoldTimeStart = Convert.ToDateTime(item);
                    //    GoldTimeStart1 = Convert.ToDateTime(item);
                    //}
                    //foreach (var item in GameProperties.GoldTimeEnd.Split('|'))
                    //{
                    //    GoldTimeEnd = Convert.ToDateTime(item.Split('|')[0]);
                    //    GoldTimeEnd1 = Convert.ToDateTime(item.Split('|')[1]);
                    //}
