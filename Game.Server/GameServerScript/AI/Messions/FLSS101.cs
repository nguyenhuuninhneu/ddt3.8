...
namespace GameServerScript.AI.Messions
{
    public class FLSS101 : AMissionControl
    {
        ...
        private void SendQuizWindow()
        {
            ...
            CreateNpc();
            isBeginResult = true;
            Game.SendOpenPopupQuestionFrame(currQuizID + 1, arightResultCount, needArightResult, maxQuizSize, timeOut, LanguageMgr.GetTranslation("FightLab.caption"),
        ...
        public override bool CanGameOver()
        {
            if (arightResultCount >= needArightResult)
            {
                Game.SendClosePopupQuestionFrame();
                Game.WaitTime(1000);
                Game.IsWin = true;
                return true;
            }
