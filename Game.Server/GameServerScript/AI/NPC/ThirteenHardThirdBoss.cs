...
namespace GameServerScript.AI.NPC
{
    public class ThirteenHardThirdBoss : ABrain
    {
        ...
        private string[] Chat_CallFriendAttacking = { "Ngươi sẽ bị đè bẹp như thịt viên!",
                                                       "Tự nhiên thèm thịt viên quá ta!",
                                                       "Ngươi có muốn thành tờ giấy mỏng không?!",
                                                       "Ái chà! Con mồi của ta!"
        };

        private string[] Chat_CallChoiceTarget = { "Không sai! Chính là ngươi!",
                                                    "Người tiếp theo sẽ là ngươi",
                                                    "Ngươi. Chính ngươi đấy!!"};

        private string[] Chat_CallFriendFucking = { "Mi bị cái gì thế?",
                                                    "Dior đang làm gì vậy!",
                                                    "Ngươi muốn bị ta lột da hả???",
                                                    "Này Quỷ khăn hồng, mi có để ý ta đang ở đó không vậy?",
        ...
        public override void OnBeginSelfTurn()
        {
            ...
            m_bloodHeal = Body.MaxBlood / 100 * 12;
        }
        ...
        private void NextWalkAttack()
        {
            ...
            if (npcs.Length > 0)
            {
                foreach (SimpleNpc npc in npcs)
                {
                    ...
                    // run pass to client
                    Body.ChangeDirection(npc, 1000);

                    if (Body.FindDirection(npc) == 1)
                    {
                        ...
                        Body.MoveTo(Game.Map.Bound.Width, Body.Y, "walk", 30, "", 2000, CallDamageListPlayers, 2000);
                    ...
                    else
                    {
                        ...
                        Body.MoveTo(0, Body.Y, "walk", 30, "", 2000, CallDamageListPlayers, 2000);
                    }
        ...
        private void HealBloodOrWalkup()
        {
            ...
            else
            {
                ...
                Body.Say(Chat_CallFriendFucking[rand], 1, 2000, 3000);
            }
        ...
        private void FindNextTarget()
        {
            ...
            Body.Say(Chat_CallChoiceTarget[rand], 1, 1000, 0);
        ...
        private void FindRandomTarget()
        {
            ...
            Body.Say(Chat_CallFriendAttacking[rand], 1, 1000, 0);
