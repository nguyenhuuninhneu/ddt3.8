...
namespace GameServerScript.AI.NPC
{
	...
	public class TwelveNormalFlyThirdBoss : ABrain
	{
		...
		private void ReadyElectricAttack()
		{
			...
			int index = base.Game.Random.Next(0, TwelveNormalFlyThirdBoss.ElectricChat.Length);
			base.Body.Say(TwelveNormalFlyThirdBoss.ElectricChat[index], 1, 0);
		...
		private void HoleAttack()
		{
			...
			int index = base.Game.Random.Next(0, TwelveNormalFlyThirdBoss.HoleChat.Length);
			base.Body.Say(TwelveNormalFlyThirdBoss.HoleChat[index], 1, 0);
			foreach (Player allFightPlayer in base.Game.GetAllFightPlayers())
			{
