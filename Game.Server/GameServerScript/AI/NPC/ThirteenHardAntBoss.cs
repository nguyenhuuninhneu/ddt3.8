...
namespace GameServerScript.AI.NPC
{
    public class ThirteenHardAntBoss : ABrain
    {
        ...
        private void method_1()
        {
			...
			base.Body.Say(string_0[num], 0, 1000, 0);
        ...
        private void method_2()
        {
			...
			int num = base.Game.Random.Next(0, xoYsxiyXcgd.Length);
			base.Body.Say(xoYsxiyXcgd[num], 0, 1000, 6000);
        ...
        private void method_4(List<Player> roxRJ2VSi5MwnkiSrp9)
        {
			...
			foreach (Player item in roxRJ2VSi5MwnkiSrp9)
			{
