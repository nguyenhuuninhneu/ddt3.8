...
namespace GameServerScript.AI.NPC
{
    public class ThirteenTerrorBrynBoss : ABrain
    {
        ...
        {
			JrtsAthKaix.Delay = base.Game.GetHighDelayTurn() + 1;
        ...
        private void method_11(List<Player> dYhRqKCsULP9SvTkZRU)
        {
			...
			foreach (Player item in dYhRqKCsULP9SvTkZRU)
			{
        ...
        private void method_4()
        {
			...
			JrtsAthKaix.Delay = base.Game.GetLowDelayTurn() - 1;
        }
        ...
        private void method_6()
        {
			...
			foreach (Player allLivingPlayer in base.Game.GetAllLivingPlayers())
			{
				...
				case 1:
					...
					allLivingPlayer.AddEffect(new ReduceStrengthEffect(2, int_3), 1500);
					break;
				default:
					list_0.Add((base.Game as PVEGame).Createlayer(allLivingPlayer.X, allLivingPlayer.Y, "", "asset.game.ten.pilao", "", 1, 0));
        ...
        public override void OnBeginSelfTurn()
        {
			...
			if (JrtsAthKaix == null)
			{
				SimpleBoss[] array = ((PVEGame)base.Game).FindLivingTurnBossWithID(int_2);
				if (array.Length != 0)
				{
					JrtsAthKaix = array[0];
				}
