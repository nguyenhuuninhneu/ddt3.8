            ...
            else
            {
                ...
                if (info != null && count <= info.Count)
                {
                    ...
                    if (amor == 0)
                    {
                        ...
                        {
                            removeNeedCount = Math.Ceiling(needWeaponExp / info.Template.Property2);
                            decimal NeedExp = removeNeedCount * info.Template.Property2;
                            
                            if(player.RemoveTemplate(eatItem, (int)removeNeedCount))
                            {
                                UpGrade(player, amor, type, (int)NeedExp, info);
                            }
                        }
                    }
                    if (amor == 1)
                    {
                        if (totalPoint < needClothesExp)
                        {
                        ...
                        {
                            removeNeedCount = Math.Ceiling(needClothesExp / info.Template.Property2);
                            decimal NeedExp = removeNeedCount * info.Template.Property2;
                    ...
                    if (amor == 2)
                    {
                        ...
                        {
                            removeNeedCount = Math.Ceiling(needHatExp / info.Template.Property2);
                            decimal NeedExp = removeNeedCount * info.Template.Property2;
