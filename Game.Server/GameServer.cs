    ...
    public class GameServer : BaseServer
    {
        ...
        protected void WorldBossScan(object sender)
        {
            try
            {
                ...
                {
                    CheckOpenBoss(allPlayers, npcID, worldBossID, startTime_MidDay, stopTime_MidDay, closeTime_MidDay);
                    CheckOpenBoss(allPlayers, npcID, worldBossID, startTime_NightTime, stopTime_NightTime, closeTime_NightTime);
                }
        ...
        private void CheckOpenBoss(GamePlayer[] players, int npcID, int worldBossID, DateTime startTime, DateTime stopTime, DateTime closeTime)
        {
            ...
            if (!RoomMgr.WorldBossRoom.WorldOpen && DateTime.Now >= startTime && DateTime.Now < stopTime)
            {
                ...
                RoomMgr.WorldBossRoom.BossResourceId = worldBossID.ToString();
