        ...
        public void UpdatePlayerProperties()
        {
            ...
            try
            {
                ...
                lock (m_lock)
                {
                    ...
                    {
                        attack += m_player.Rank.CurrentRank.Attack;
                        defence += m_player.Rank.CurrentRank.Defence;
                        agility += m_player.Rank.CurrentRank.Agility;
                        lucky += m_player.Rank.CurrentRank.Luck;
                        if (m_player.Rank.CurrentRank.Info != null)
                        {
                            attack += m_player.Rank.CurrentRank.Info.Att;
                            defence += m_player.Rank.CurrentRank.Info.Def;
                            agility += m_player.Rank.CurrentRank.Info.Agi;
                            lucky += m_player.Rank.CurrentRank.Info.Luck;
                        }
                    }
