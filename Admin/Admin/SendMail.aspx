...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="SearchPanel" runat="server">
        <div class="formPanel">
            <fieldset>
                <legend>Gửi thư</legend>
                <p>
                    <asp:Label ID="Label1" runat="server" Text="Tên nhân vật" AssociatedControlID="UserName_tbx"></asp:Label>
                ...
                <p>
                    <asp:Label ID="Label3" runat="server" AssociatedControlID="Content_tbx" 
                        style="margin-right: 2px" Text="Thông tin"></asp:Label>
                ...
                <p>
                    <asp:Button ID="SendMail_btn" runat="server" Text="Gửi thư" 
