            ...
            <tr>
                ...
                <span id="sp_SelectStr">   
                    <select id="SelectStr" class="style303" name="D2" >
						...
						<option value="13">[Cấp 1]</option>
                        <option value="14">[Cấp 2]</option>
						<option value="15">[Cấp 3]</option>
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td class="style302">
                                    Tấn công</td>
                                <td>
                                    <input  maxlength="3" id="Txt_att" class="style309" type="text" /></td>
                            </tr>
                            <tr>
                                <td class="style307">
                                    &nbsp;</td>
                                <td class="style302">
                                    Phòng Thủ</td>
                                <td>
                                    <input  maxlength="3" id="Txt_def" class="style309" type="text" /></td>
                            </tr>
                            <tr>
                                <td class="style307">
                                    &nbsp;</td>
                                <td class="style302">
                                    Nhanh nhẹn</td>
                                <td>
                                    <input  maxlength="3" id="Txt_agi" class="style309" type="text" /></td>
                            </tr>
                            <tr>
                                <td class="style307">
                                    &nbsp;</td>
                                <td class="style302">
                                    May mắn</td>
                                <td>
                                    <input  maxlength="3" id="Txt_luc" class="style309" type="text" /></td>
                            </tr>
                        </table>
                    </div>
                </td>
