    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            ...
            function call_addItems(GoodIDs, count) {
				...
				var HiddenItem6 = $("#HiddenItem6");
                var HiddenItem7 = $("#HiddenItem6");
                if (HiddenItem1.val() == "") {
                    ...
                    msgbox.html("TỐI TA CHỈ CÓ THỂ ĐƯỢC 5 ITEM")
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table  style="width:100%;">
        <tr>
            ...
            onmouseout="$(this).css({ background: '#999999', color: '#999999'});" 
            onmouseover="$(this).css({ background: '#999999', color: '#999999'});">
             Gửi Vật Phẩm
                </td>
                <td class="style1451" 
            ...
            <td colspan="4">
                <div id="divSendMail" class="style1476">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="style1454">
                                <span class="style1465">Nội dung:</span></td>
                        </tr>
                        <tr>
                            <td class="style1454">
                        ...
                        <tr>
                            <td class="style1455">
                                <font color="green"<b>Loại Item</b></font>
                            ...
                            <td class="style1454">
                                <table cellpadding="0" cellspacing="0" class="style1462">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style1470">
                                            <input onclick="call_SendMail();" id="Button1" type="button" value="Hoàn Tất" class="style1480" /></td>
                                    </tr>
                                    </table>
                            </td>
                        </tr>
                ...
                <div id="divSendMoney" class="style1450">
                    <table class="style1471">
                        ...
                        <tr>
                            ...
                            <td class="style1474">
                            <input id="TxtMoney" value="99999999" class="style1457" type="text" /></td>
                        </tr>
                        <tr>
                            <td class="style1475">
                            <span class="style1465">Vàng (Gold):</span></td>
                            <td class="style1474">
                            <input id="TxtGold" value="99999999" class="style1457" type="text" /></td>
                        </tr>
                        <tr>
                            <td class="style1475">
                            <span class="style1465">Lễ Kim (GifToken):</span></td>
                            <td class="style1474">
                            <input id="TxtGiftToken" value="99999999" class="style1457" type="text" /></td>
                        </tr>
                        <tr>
