    ...
    <style type="text/css">
        ...
        <script type="text/javascript">
            ...
            function printTBCount(count, getIDs) {
                var container = '<div id="get_count" style=" width: 147px; height: 72px; background-color: #858584;">';
                container += '<table style="width: 145px; height: 70px;"><tr>';
                container += '<td style="width: 79px; height: 30px; color: #EC0606;">';
                            ...
                            <td class="style1454">
                                <table cellpadding="0" cellspacing="0" class="style1462">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style1470">
                                            <input onclick="call_SendMail();" id="Button1" type="button" value="Gửi Thư" class="style1480" /></td>
                                    </tr>
                                    </table>
                            </td>
                        </tr>
